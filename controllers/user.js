...
exports.getUserCart = async (req, res)=> {
    ...
    let cart = await Cart.findOne({orderBy: user._id}).populate('products.product', '_id total price title totalAfterDiscount').exec()
...
exports.emptyCart = async (req, res) => {
    ...
    const cart = await (await Cart.findOneAndRemove({orderBy: user._id})).execPopulate()
...
exports.applyCouponToUserCart = async (req, res) => {
    ...
    let {product, cartTotal} = await Cart.findOne({orderBy: user._id}).populate('products.product', '_id title price').exec()
...
console.log('Product quantity decremented, sold++ ',updated)
